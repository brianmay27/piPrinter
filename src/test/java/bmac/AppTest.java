...
public class AppTest extends TestCase {
    ...
    public void testApp() throws Exception {
        ...
        HttpGet get = new HttpGet("http://localhost:8080/print/print.app");
...
//        } else {
//            assertTrue("Hello response is wrong", EntityUtils.toString(entity).contains("hello web, from the Aura sample app print"));
//        }
    }
}
