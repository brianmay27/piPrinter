...
public class LittleEndianConverter
{
    ...
    * @throws java.io.IOException if EOF occurs and only one, 2 or 3 bytes were read or
    ...
    * <code>0xFFFF</code>.
    * @throws java.io.IOException if EOF occurs and only one bytes was read or
    *      if error during reading occurs
    */
    ...
    * To Convert it to an unsigned int <code>&</code> the result with
    * <code>0xFFFFFF</code>.
    * @throws java.io.IOException if EOF occurs and only one or 2 bytes were read or
    *      if error during reading occurs
    */
